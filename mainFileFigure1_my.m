...
%
%Ozgecan Ozdogan, Emil Bjornson, Erik G. Larsson, â€œMassive MIMO with
%Spatially Correlated Rician Fading Channels,â€? IEEE Transactions on
...
legend([m1 m2 m3 m1r m3r ],'MMSE with Rician fading',' EW-MMSE with Rician fading'...
    ,'LS with Rician fading','MMSE with Rayleigh fading', 'EW-MMSE/LS with Rayleigh','Location','NorthWest');
